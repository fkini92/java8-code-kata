...
public class Exercise4Test {
    ...
    public void zonedDateTimeOf() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(2015, 7, 10, 2, 14, 25), ZoneId.of("Asia/Tokyo"));
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_HH_mm_ss_zz"));
